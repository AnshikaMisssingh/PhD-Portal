...
<br><br>
	...
	<br><br>
	<form action="viewsys.jsp">
	 &emsp;&emsp;&ensp;&emsp;<input type="Submit" value="View Synopsis Marks">
	</form><br>
	
	<form action="viewthesis.jsp">&emsp;&emsp;&emsp;&ensp;
	<input type="Submit" value="View Thesis Marks">
	</form>
	<br><br>
<%
String strUser = request.getParameter("sid");
