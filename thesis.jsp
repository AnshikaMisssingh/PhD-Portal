...
<br><br>
	...
	<form action="changepass.jsp">&emsp;&emsp;&emsp;&emsp;<input type="submit" value="Change Password"></form><br>
	<form action="Prelogin.jsp">&emsp;&emsp;&ensp;&emsp;&emsp;&emsp;<input type="submit" value="Logout"></form><br>
	...
	<br><br><br>
	<form action="evalupload.jsp">&emsp;&emsp;&ensp;&ensp;&emsp;&emsp;&ensp;<input type="submit" value="Upload"></form><br>
	<form action="fillform.jsp">&emsp;&emsp;&ensp;&ensp;&emsp;&ensp;&ensp;<input type="submit" value="Fill Form"></form>
	<br><br>
