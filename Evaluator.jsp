...
<br><br>
	...
	<br><br>
	<form action="evalupload.jsp">&emsp;&emsp;&ensp;&ensp;<input type="submit" value="Synopysis Marks Upload"></form><br>
	<form action="fillformthesis.jsp">&emsp;&emsp;&emsp;&ensp;<input type="submit" value="Thesis Marks Uplaod"></form>
	<br><br>
