...
<body topmargin=140>
<body background="bgrail.jpeg" style="background-repeat:no-repeat; background-size:100% 100%">
	<form action="reachus.jsp">
	<br>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&ensp;&ensp;<input type="submit" value="Back"></form>
	&emsp;&emsp;&emsp;&emsp;&ensp;<a href= "http://www.banasthali.org/banasthali/wcms/en/home/index.html"><input type="submit" value="Go To Home Page"></a><br>
