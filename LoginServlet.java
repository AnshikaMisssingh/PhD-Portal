	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
				if(loginDao.validate(loginBean))
				{
					...
					{
						if(id.equals("ayra_veena@banasthali.in"))
						{
							RequestDispatcher req = request.getRequestDispatcher("vccms.jsp");
							req.include(request, response);
						}
						else if(id.equals("ckjha@banasthali.in"))
						{
							RequestDispatcher req = request.getRequestDispatcher("vcai.jsp");
							req.include(request, response);
						}
						else if(id.equals("abhishekpareek@banasthali.in"))
						{
							RequestDispatcher req = request.getRequestDispatcher("vcwisdom.jsp");
							req.include(request, response);
						}
						else if(id.equals("pooja_sharma@banasthali.in"))
						{
							RequestDispatcher req = request.getRequestDispatcher("vcsoa.jsp");
							req.include(request, response);
						}
						else if(id.equals("rekha_roy@banasthali.in"))
						{
							RequestDispatcher req = request.getRequestDispatcher("vcchem.jsp");
							req.include(request, response);
						}
					}
