...
<%
	try{
		...
		ResultSet rs= st.executeQuery("select hod_name, email, phone_no from department where department_id='SOA101'");
		while(rs.next())
		{
%>
...
<%		
		ResultSet rs0= st.executeQuery("select sup_id, name from supervisor where department_id='SOA101'");
		while(rs0.next())
		{
%>
