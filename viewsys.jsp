...
<font size=5>SYNOPSIS DETAILS</font>	
...
<%
	try{
		...
		ResultSet rs0= st.executeQuery("select student_name, student_id, project_name, evaluator_name, evaluator_id, suitability_score, originality_score, intro_bckgrnd_score from sys_eval where student_id='PDHTC19421'");
		while(rs0.next())
		{
%>
...
<tr>
	...
	<td><b>Accept Word</b></td>
	
</tr>	

<%		
		ResultSet rs1= st.executeQuery("select Problem_stmt_score, design_method_score, relevancy_score, language_score, quantum_of_work_score, reference_score, overall_score, accept_word from sys_eval where student_id='PDHTC19421'");
		while(rs1.next())
		{
%>
...
<tr>
	<td><b>Minor Revision</b></td>
	<td><b>Major Revision</b></td>
	<td><b>Reasons</b></td>
	<td><b>Comments</b></td>
</tr>	

<%		
		ResultSet rs2= st.executeQuery("select minor_revision, major_revision, reasons, comments from sys_eval where student_id='PDHTC19421'");
		while(rs2.next())
		{
%>
